...
export const createUser = {
  ...
  resolve(_ : any, args : any, ctx : any) { // TODO : prisma로 create user 구현
...
export const updateUser = {
  ...
  resolve(_ : any, args : any, ctx : any) { // TODO : prisma로 update user 구현
    const mock_user = args.user 
    return mock_user
  },
  type: 'User'
...
export const deleteUser = {
  resolve(_ : any, args : any, ctx : any) { // TODO : prisma로 delete user 구현
    const mock_user = { 
      id : 1,
      name : "mock_user-name",
      school : 1,
